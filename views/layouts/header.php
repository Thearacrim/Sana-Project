    ...
    <div class="align-self-center collapse navbar-collapse justify-content-lg-between mt-3" id="templatemo_main_nav">
      <div class="flex-fill">
        <ul class="nav navbar-nav d-flex justify-content-start mx-lg-auto">
          ...
          <li class="dropdown">
            <a href="<?= Url::to(['site/store-women']) ?>" class="dropdown-toggle a-title" data-toggle="">WOMEN <b
                class="caret"></b></a>
        ...
        <div class="btn-group pl-3">
          <div class="dropdown">
            <a class="" href="#" id="dropdownMenuButton" data-toggle="dropdown"
              data-bs-toggle="dropdown" data-bs-display="static" aria-haspopup="true" aria-expanded="false"style="font-size: 1.5rem;">
