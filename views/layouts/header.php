        ...
        <div class="align-self-center collapse navbar-collapse justify-content-lg-between mt-3" id="templatemo_main_nav">
            <div class="flex-fill">
                <ul class="nav navbar-nav d-flex justify-content-start mx-lg-auto">
                    ...
                    <li class="dropdown">
                        <a href="<?= Url::to(['site/store-women']) ?>" class="dropdown-toggle a-title" data-toggle="">WOMEN <b class="caret"></b></a>
            ...
            <div class="navbar1 align-self-center d-flex">
                <a class="nav-icon d-lg-inline icon-menu" href="#" data-bs-toggle="modal" data-bs-target="#templatemo_search">
                ...
                if (Yii::$app->user->isGuest) {
                ?>
                    <a class="nav-icon position-relative text-decoration-none pl-3" value="login" href="<?= Url::to(['site/login']) ?>">
                ...
                ?>
                    <a class="nav-icon position-relative text-decoration-none pl-3" value="login" href="<?= Url::to(['/site/favorites']) ?>">
                        <i class="fa-regular fa-heart text-color mr-1 font_icon" style="font-size: 1.5rem;"></i>
                        <span id="favortie-quantity" class="position-absolute top-0 left-100 translate-middle badge rounded-pill badge badge-danger"><?= $favoritestotal ?></span>
                    </a>
                ...
                ?>
                    ...
                    <a class="nav-icon position-relative text-decoration-none pl-3" value="login" href="<?= Url::to(['/site/login']) ?>">
                        <svg xmlns="http://www.w3.org/2000/svg" id="Outline" viewBox="0 0 24 24" width="1.5rem" class="bag-icon" height="1.5rem">
                ...
                ?>
                    <a class="nav-icon position-relative text-decoration-none bag-shop pl-3" href="<?= Url::to(['site/cart']) ?>">
                        <svg xmlns="http://www.w3.org/2000/svg" id="Outline" viewBox="0 0 24 24" width="1.5rem" class="bag-icon" height="1.5rem">
                            <path d="M21,6H18A6,6,0,0,0,6,6H3A3,3,0,0,0,0,9V19a5.006,5.006,0,0,0,5,5H19a5.006,5.006,0,0,0,5-5V9A3,3,0,0,0,21,6ZM12,2a4,4,0,0,1,4,4H8A4,4,0,0,1,12,2ZM22,19a3,3,0,0,1-3,3H5a3,3,0,0,1-3-3V9A1,1,0,0,1,3,8H6v2a1,1,0,0,0,2,0V8h8v2a1,1,0,0,0,2,0V8h3a1,1,0,0,1,1,1Z" />
                        </svg>
                        <span id="cart-quantity" class="position-absolute top-0 left-100 translate-middle badge rounded-pill badge badge-danger"><?= $totalCart ?></span>
          ...
          <a style="cursor:poiter" value="<?= Url::to(['/site/sign']) ?>" class="trigggerModal">SignUp<i class="fas fa-sign-up-alt"><i></a> -->
                ...
                ?>
                    ...
                    <div class="btn-group pl-3">
                        <div class="dropdown">
                            <a class="" href="#" id="dropdownMenuButton" data-toggle="dropdown" data-bs-toggle="dropdown" data-bs-display="static" aria-haspopup="true" aria-expanded="false" style="font-size: 1.5rem;">
                            ...
                            <div class=" dropdown-menu back-light" aria-labelledby="dropdownMenuButton">
                                ...
                                <a class="dropdown-item d-flex justify-content-between" href="<?= Url::to(['site/profile']) ?>">
                                    ...
                                    ?>
                                        <img class="rounded-circle mr-3" src="<?= $base_url ?>/uploads/orionthemes-placeholder-image-1.png ?> ?>" style="width:60px;height:60px;object-fit: cover;" alt="profile">
                                    <?php } else { ?>
