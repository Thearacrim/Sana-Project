    ...
    <div class="container d-flex justify-content-between align-items-center">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu mega-menu submenu" style="background-color: #edf2fc;">
                            ...
                            <li class="mega-menu-column">
                                <ul>
                                    <li class="nav-header"><a
                                            href="<?= Url::to(['site/store-all-bottoms-woman']) ?>">ALL
                                            BOTTOMES</a></li>
        ...
        <div class="navbar1 align-self-center d-flex">
            ...
            <?php
                ...
                ?>
            <a class="nav-icon position-relative text-decoration-none pl-3 d-none" value="login"
                href="<?= Url::to(['/site/favorites']) ?>">
                <i class="fa-regular fa-heart text-color mr-1 font_icon" style="font-size: 1.5rem;"></i>
                <span id="favortie-quantity"
                    class="position-absolute top-0 left-100 translate-middle badge rounded-pill badge badge-danger"><?= $favoritestotal?></span>
        ...
        ?>
            ...
            <a style="cursor:poiter;text-decoration:none;padding:0 3px;" href="<?= Url::to(['/site/login']) ?>"
                class="pl-3">Login<i class="fas fa-user" style="padding:0 3px"></i></a>
            <?php
        } else {
        ?>
            <?php $menuItems[] = ['label' => ''] ?>
