...
<br>
  <div class="container">
      <div class="clearfix">
          <h2 class="d-flex justify-content-center">RECOMMENDED FOR YOU </h2><hr>
      </div>
      <div class="container">
  <section class="py-5">
      <div class="row ">
        ...
        <div class="col-lg-2 mb-5 product-item">
          <div class="card h-100 shadow">
                  ...
                  <li>
                      <a class="btn btn-danger btn-sm text-white btn-add-to-fav product-item  <?= $isFav?>" href="#" data-id="<?=$value->id?>"><i class="far fa-heart"></i></a>
                  </li>
                  <li>
                      <a class="btn btn-danger btn-sm text-white mt-2" href="<?= Url::to(['store-single', 'id' => $value->id]) ?>"><i class="far fa-eye"></i></a>
                  </li>
              </ul>
            <a href="<?= Url::to(['store-single', 'id' => $value['id']]) ?>">
              <img class="card-img-top" src="<?= $base_url . '/' . $value['image_url'] ?>">
      ...
      <div class="text-center">
        <a class="btn btn-primary btn-sm btn-add-to-cart rounded-0" href="<?= Url::to(['site/add-cart']) ?>"></i>Learn More</a>
      </div> 
  </section>
</div> 
</div>
