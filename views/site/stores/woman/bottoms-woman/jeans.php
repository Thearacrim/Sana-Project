...
<div class="container py-5">
  <div class="row">
    ...
    <!-- cart-section -->
    <div class="col-lg-9">
      <div class="title-man">WOMAN'S JEANS</div>
      <hr>
      <div class="side-wrapper stories">
        <!-- <div class="side-title">STORIES</div> -->
        <div class="user">
          <img
            src="https://images.unsplash.com/photo-1618453292459-53424b66bb6a?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=464&q=80"
            alt="" class="user-img">
        ...
        <div class="user">
          <img
            src="https://cdn.shopify.com/s/files/1/0082/0356/7215/products/logo-embroidered-men-track-pants-1990-moi-outfit-631797.jpg?v=1673308814"
            alt="" class="user-img">
        ...
        <div class="user">
          <img
            src="https://cdn.shopify.com/s/files/1/0082/0356/7215/products/cuff-logo-embroidered-quarter-socks-3-pairs-890-moi-outfit-995871.jpg?v=1662791823"
            alt="" class="user-img">
                ...
                <div class="carousel-item active">
                  <div class="row">
                    <div class="col-3 p-md-5">
                      <a href="#"><img class="img-fluid brand-img" src="<?= $base_url ?>/template/img/brand_01.png"
                          alt="Brand Logo"></a>
                    </div>
                    <div class="col-3 p-md-5">
                      <a href="#"><img class="img-fluid brand-img" src="<?= $base_url ?>/template/img/brand_02.png"
                          alt="Brand Logo"></a>
                    </div>
                    <div class="col-3 p-md-5">
                      <a href="#"><img class="img-fluid brand-img" src="<?= $base_url ?>/template/img/brand_03.png"
                          alt="Brand Logo"></a>
                    </div>
                    <div class="col-3 p-md-5">
                      <a href="#"><img class="img-fluid brand-img" src="<?= $base_url ?>/template/img/brand_04.png"
                          alt="Brand Logo"></a>
                    </div>
                  </div>
                </div>
