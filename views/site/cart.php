...
?>
            ...
            <div class="sec-border row_item_<?=$product['cart_id']?> rounded-0 hover p-3">
              <div class="row ">
                ...
                <div class="col-lg-6">
                  ...
                  <span class="price">
                    <ul class="list-inline">
                      ...
                      <li class="list-inline-item"><span class="btn btn-dark btn-sm rounded-circle text-color">
                          <?=$product['size']?></span></li>
                    </ul>
                  </span>
                  <a data-id=<?=$product['cart_id']?> data-save=<?=$product['id']?>
                    href="<?=Url::to(['store-single', 'id' => $product['cart_id']])?>"
                    class="btn btn-outline-warning btn-sm rounded-0 btn-save-for-later">Save for later</a>
                  <?php echo Html::a(
                      'Remove',
                ...
                <div class="qty col-lg-3 col-md-8 col-sm-12 center d-inline py-5">
                  <span class="minus bg-dark spinner item-quantity" data-product_id="<?=$product['id']?>"
                    data-id=<?=$product['cart_id']?>>-</span>
                  <input type="number" min='1' id="item-quantity_<?=$product['cart_id']?>" class="count item-quantity"
                    name="qty" value="<?=$product['quantity']?>">
                  <span class="plus bg-dark spinner item-quantity" data-product_id="<?=$product['id']?>"
                    data-id=<?=$product['cart_id']?>>+</span>
                </div>
              </div>
            </div>
              ...
              <div class="row ">
                ...
                <div class="col-4">
                  <a class="btn btn-outline-secondary btn-sm rounded-0 btn-move-to-cart"
                    ...
                    href="<?=Url::to(['site/store-single', 'id' => $product['id']])?>">Move to cart</a>
                </div>
              </div>
            </div>
            <?php }?>
      ...
      <div class="col-lg-4 rounded price-section">
        ...
        <div class="card-body border">
          ...
          <hr>
          <a href="<?=Url::to(['site/checkout'])?>"><button
      ...
      <div class="card rounded-0">
        ...
        <div class="card-img-overlay rounded-0 product-overlay d-flex align-items-center justify-content-center">
          <ul class="list-unstyled">
            ...
            <li>
              <a class="btn btn-success text-white mt-2" href="<?=Url::to(['store-single', 'id' => $model->id])?>"><i
